  ...
  return (
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="text-gray-500 dark:text-slate-400 max-w-md mx-auto mt-4 flex flex-col gap-4">
      ...
      <section className="text-center my-8" id="contact">
        ...
        <div className="mt-8">
          <a className="text-4xl underline text-gray-500 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors" href="tel:+46738123123">+46 738 123 123</a>
        </div>
      </section>
    </>
  );
